...
get.emp.liq <- function(cidade, cd_funcao){
  ...
  emp.liq <- dbSendQuery(mydb, paste("select e.nu_Empenho, l.cd_UGestora, e.dt_Ano, e.cd_UnidOrcamentaria, e.cd_Credor, e.no_Credor, e.vl_Empenho,
  ...
  diff.emp.liq <- data.emp.liq %>%
    group_by(nu_Empenho, cd_UGestora, cd_UnidOrcamentaria, dt_Ano, cd_Credor, no_Credor, vl_Empenho) %>%
...
get.emp.pag <- function(cidade, cd_funcao){
  ...
  emp.pag <- dbSendQuery(mydb, paste("select e.nu_Empenho, p.cd_UGestora, e.dt_Ano, e.cd_UnidOrcamentaria, e.cd_Credor, e.no_Credor, e.vl_Empenho,
